...
const articles = [
    {
        ...
        content: `
            ...
            <ul>
                ...
                <li className="break-keep text-brand"><strong>✨ Limited Edition:</strong> 런칭 행사 참가자 분들께만 특별히 제작해 드리는 실물 <strong>'VIBE Profile Card'</strong>를 현장에서 신청을 통해 받아보실 수 있습니다.</li>
            </ul>
